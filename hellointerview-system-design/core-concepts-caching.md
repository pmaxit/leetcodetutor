# Caching for System Design Interviews | Hello Interview System Design in a Hurry
...
For user-facing caching, you have limited control from the backend. Data can go stale and invalidation is harder. The [Strava app](/learn/system-design/problem-breakdowns/strava) keeps your run data on the device while you are offline and syncs it later. A browser reusing a previously downloaded image from disk is also caching.
...
[• 1 month ago](#comment-cmmjhki0n06sj07adyxnc44b1)
...
[• 1 month ago](#comment-cmmji91t207q108ad5if82fk5)
...
![Tautik Agrahari](https://lh3.googleusercontent.com/a/ACg8ocK8JKfyUQqlO3RAraRkpDxtP18Zsnu5WqUcYElGSxzqrVGSmQ7xyw=s96-c)
...
[• 11 hours ago](#comment-cmos941c107qv0ead5de6dgms)
...
[• 1 month ago](#comment-cmmqqir100qsv08ad9ggknooq)
...
![Khánh Trần Duy](https://lh3.googleusercontent.com/a/ACg8ocLBYRvx0nGwxEZex7YO4Rl45o4DgsMCXusSqzGE8WB4xvOc6g=s96-c)
...
[• 6 months ago](#comment-cmhcvcsvu051k08adn1i10iv3)
...
[• 3 months ago](#comment-cmkhpm2qo03en07adwm171ex8)
...
![Pavan Rangudu](https://lh3.googleusercontent.com/a/ACg8ocL4eF0FQq48NdvHvtGYW4Q-UaPMwOSjtTYNnvGSbyaaxwzIFMBY=s96-c)
...
[• 1 month ago](#comment-cmmr1kul912ju09adjw19ujt2)
...
[• 4 months ago](#comment-cmjjl24aq05ok08ad0jp3bam2)
...
[• 2 months ago](#comment-cmm9ipm9w007108adzo291jej)

It's mentioned in the scaling reads

[https://www.hellointerview.com/learn/system-design/patterns/scaling-reads#application-level-caching](https://www.hellointerview.com/learn/system-design/patterns/scaling-reads#application-level-caching)
...
[• 3 months ago](#comment-cmk461oe306a808adsrp4e1t4)

Under Cache Consistency — “_Short TTLs for stale tolerance: Let slightly stale data live temporarily if eventual consistency is acceptable._” If eventual consistency is tolerable, wouldn’t you use longer TTLs rather than shorter ones?
...
[• 3 months ago](#comment-cmkhpq7c403h107ad8m9jyqux)

It's dependent upon how much staleness we can tolerate. User profile updates should be visible in 1/5/10 mins? Depends on the particular scenario
